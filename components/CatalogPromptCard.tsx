 ...
 *
 * There is no answer-options list and no explanation: an LLM-graded prompt is the whole item, and
 * the grading rubric lives in lib/llm/promptUtils.ts rather than per prompt.
 */
