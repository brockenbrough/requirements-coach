...
- `question.user_id` (GitHub #201) records which instructor authored a question, for a future "scope to my quiz's questions" (#116) — nothing reads it yet since `app/instructor/questions/page.tsx` is still on `MOCK_QUESTIONS` (see world 3 below).
